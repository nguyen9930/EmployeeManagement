...
public class DialogSelectEmployee extends javax.swing.JDialog {
    ...
    /** táº¡o má»›i form SelectEmployeeDialog */
    public DialogSelectEmployee(java.awt.Frame parent, boolean modal) {
        ...
        JComboBox tblData = null;
		tblData.setModel((ComboBoxModel) mdlTable);
    ...
    private void loadDataToComboBox() {
        try {
            ...
            cboLocation.addItem("Táº¥t cáº£ Ä‘á»‹a chá»‰");
            ...
            cboDepartment.addItem("Táº¥t cáº£ phÃ²ng ban");
            ...
            cboProject.addItem("Táº¥t cáº£ dá»± Ã¡n");
    ...
    private void initComponents() {
        ...
        JXTable tblData = new org.jdesktop.swingx.JXTable();
        ...
        pnlSearch.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "TÃ¬m kiáº¿m", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 12))); // NOI18N
        pnlSearch.setPreferredSize(new java.awt.Dimension(640, 200));
        pnlSearch.setRequestFocusEnabled(false);

        jLabel1.setText("MÃ£ nhÃ¢n viÃªn");

        jLabel2.setText("TÃªn Ä‘áº§y Ä‘á»§");
                ...
                .addGroup(pnlSearchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(pnlSearchLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlSearchLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cboDepartment, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void loadData() {//Táº£i dá»¯ liá»‡u vÃ o báº£ng
        try {
            /*Nháº­n dá»¯ liá»‡u*/
            empLst = null;
            empLst = EmployeeDAO.selectAllEmployeeByCondition(makeConditionString());

            String[] cols = new String[]{"MÃ£", "TÃªn Ä‘áº§y Ä‘á»§", "TÃªn Ä‘Äƒng nháº­p", "Ä�á»‹a chá»‰", "PhÃ²ng ban", "Dá»± Ã¡n"};
    ...
    private String makeConditionString() {//Táº¡o chuá»—i Ä‘iá»�u kiá»‡n Ä‘áº§u vÃ o
        ...
        /*Thá»±c hiá»‡n chuá»—i Ä‘k tá»« ComboBoxes*/
        if (dept >= 0) {
    ...
    private void btnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectActionPerformed
        ...
        if (tblData.getSelectedRow() != -1)//Kiá»ƒm tra ngÆ°á»�i dÃ¹ng cÃ³ chá»�n má»™t hÃ ng nÃ o khÃ´ng
        {
            selectedEmp = empLst.get(tblData.getSelectedRow());
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Báº¡n pháº£i chá»�n má»™t hÃ ng trong báº£ng",
                    "KhÃ´ng cÃ³ hÃ ng Ä‘Ã£ chá»�n", JOptionPane.INFORMATION_MESSAGE);
        }
